...
- **Stack pins:** TypeScript 7.0.2, Node 24 LTS (`node:24-alpine`), Fastify 5.12.4, TypeBox 0.34.52 (+ `@fastify/type-provider-typebox` 6.1.0), @fastify/swagger 9.8.1, swagger-ui 6.1.1, Prisma 7.10.0 (do not take 8.x RC), PostgreSQL 18 (`postgres:18-alpine`), Vitest 5.0.0, Turborepo 2.10.12, pnpm 12.4.1, React 19.3.0, Vite 8.3.0, Tailwind CSS 4.3.3, shadcn CLI 4.21.0.
